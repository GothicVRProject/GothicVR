...
namespace GVR.Creator.Meshes.V2
{
    public class NpcHeadMeshBuilder : NpcMeshBuilder
    {
        ...
        protected override void CreateMorphMeshEntry(int index1, int index2, int index3, int preparedVerticesCount)
        {
            ...
            MorphMeshCache.AddVertexMappingEntry(headName, index1, preparedVerticesCount - 3);
            MorphMeshCache.AddVertexMappingEntry(headName, index2, preparedVerticesCount - 2);
            MorphMeshCache.AddVertexMappingEntry(headName, index3, preparedVerticesCount - 1);
        }
