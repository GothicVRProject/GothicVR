...
| Wld_InsertNpc | Füge NSC in Welt ein. Wobei SPawnpoint entweder ein WP oder ein FP sein darf. | void Wld_InsertNpc(var int npcinstance, var string spawnpoint) | High | Creates a new GameObject with the associated data. Complexity is based on additional spwan point calculation (TA_Min) |
